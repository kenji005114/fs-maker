...
export default function Sidebar() {
  ...
  return (
    <>
      <button
        className="-mx-2 fixed top-24 left-4 z-20 flex items-center justify-center rounded border-2 border-gray-300 border-solid bg-white p-2 lg:hidden dark:border-slate-700 dark:bg-slate-900"
